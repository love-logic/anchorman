...
// IIFE to prevent global namespace conflicts with other plugins
(function(thisObj) {
    "use strict";
    
    // Unique namespace to avoid conflicts
    var ANCHORMAN_NAMESPACE = "com_lovelogic_anchorman_" + Math.random().toString(36).substr(2, 9);
